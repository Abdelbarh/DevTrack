export type IconName =
  | 'plus' | 'arrowRight' | 'arrowLeft' | 'sparkle' | 'download' | 'upload'
  | 'file' | 'trash' | 'check' | 'x' | 'edit' | 'copy' | 'cmd' | 'search'
  | 'chevDown' | 'chevRight' | 'chevronUp' | 'chevronDown' | 'more' | 'dot'
  | 'github' | 'link' | 'bolt' | 'zap' | 'star' | 'sun' | 'moon' | 'loader'
  | 'book' | 'settings' | 'inbox' | 'layout' | 'user' | 'pdf' | 'eye' | 'refresh'
  | 'logOut'
...
export function Icon({ name, size = 14, stroke = 1.6, className }: IconProps) {
  const paths: Record<IconName, React.ReactNode> = {
    plus:       <><line x1="12" y1="5" x2="12" y2="19" /><line x1="5" y1="12" x2="19" y2="12" /></>,
    arrowRight: <><line x1="5" y1="12" x2="19" y2="12" /><polyline points="12 5 19 12 12 19" /></>,
    arrowLeft:  <><line x1="19" y1="12" x2="5" y2="12" /><polyline points="12 19 5 12 12 5" /></>,
    sparkle:    <><path d="M12 3 L13.5 9.5 L20 11 L13.5 12.5 L12 19 L10.5 12.5 L4 11 L10.5 9.5 Z" /></>,
